...
void GLimp_Init(void)
{
	...
	var = ri.Cvar_Get( "r_customwidth", "100", CVAR_ARCHIVE | CVAR_LATCH );
	glConfig.vidWidth = var->integer;
	var = ri.Cvar_Get( "r_customheight", "100", CVAR_ARCHIVE | CVAR_LATCH );
	glConfig.vidHeight = var->integer;
	ri.Printf(PRINT_ALL, "GLimp_Init: vidWidth=%d vidHeight=%d\n", glConfig.vidWidth, glConfig.vidHeight);
